...
public interface AquireBoard {
	 ...
	 * @return
	 */
	public abstract boolean isTilePlaced(String tileName);
	 ...
	 * @param tileName
	 */
	public abstract Entry<Tile, Corporation> getTile(String tileName);

	/**
	 * Get mutable array representing the game state...
	 * @return
	 */
	public abstract Map<Tile, NamedCorporation> getState();
	 ...
	 */
	public abstract List<Entry<Tile, Corporation>> getAffectedTiles(Tile tile);
